...
Etapes pour l'installation :
 ...
 - Choisissez la version de php de votre choix (la version de php doit être supérieure à 8.1.0) puis appuyez sur Next
 ...
 - Vérifiez les paramètres et après avoir bien vérifié, appuyez sur Install pour procéder à l'installation
...
Etapes pour l'installation :
 ...
 - Suivez les instructions données par WampServer
 
3 - Téléchargement et installation de la dernière version de VScode (1.95)
...
URL du projet : 
 ...
 Il y a deux façons de récupérer le projet : soit cloner le projet, soit téléchargé le fichier compressé du projet
...
5 - Lancement du projet 
 ...
 - Danc ce même terminal, exécuter le commande « code . », cela vous emmènera vers un éditeur de texte
...
DB_DATABASE=attente (nom de la base de données) (exemple : attente)
DB_USERNAME=root (utilisateur de la base de données) (par défaut : root)
DB_PASSWORD= (mot de passe de la base de données) (par défaut : (vide ou root))
...
- Pour le projet « accueil-opj », n’oubliez pas d’activer le pop-up afin de pouvoir fournir un ticket
